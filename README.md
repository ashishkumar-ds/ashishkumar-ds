...
- **Machine Learning & Business Modeling**: RFM Segmentation, Churn Risk Analysis, Association Rules (FP-Growth), Campaign ROI & Uplift Analysis, Time-Series Forecasting (LightGBM + Optuna)  
